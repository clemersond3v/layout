...
const Header = (): JSX.Element => {
  ...
  return (
    <header className='store-header'>
      <div className='store-header__subHeader'>
        <p>Acompanhe as melhores promoções disponíveis aqui na Maeztra.</p>
      </div>
      <div className='store-header__main'>
        <div className='store-header__main-logo'>
          <img src="" alt="" />
        </div>

        <div className='store-header__main-searchBar'>
          <input type="text" placeholder='O Que Você Busca?' />
        </div>

        <div className='store-header__main-navegateLinks'>
          <div className='store-header__main-navegateLinks--myaccount'>
          ...
          <div className='store-header__main-navegateLinks--wishList'>
          ...
          <div className='store-header__main-navegateLinks--miniCart'>
