...
import newsletterModalImage from '../../assets/newsletter-modal-image.png'

const Popup = (): JSX.Element => {
    const [isOpened, setIsOpened] = useState(false);

    useEffect(() => {
        const cookie = localStorage.getItem("@newsletterPopUpShown");

        cookie ? setIsOpened(false) : setIsOpened(true)
    }, []);
    
    function setCookieNewsletter() {
        ...
        >
          ...
          <div className='modal-newsletter'>
            <div className="modal-newsletter--overlay">
              <div className="modal-newsletter--container">
                <div className="modal-newsletter--container-main">
                  <div className="modal-newsletter--container-main__image">
                    <img src={newsletterModalImage} alt="newsletter-modal-img" />
                  </div>
                  <div className="modal-newsletter--container-main__form">
                    <form action="">
